...
TeleportDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: TeleportDirective, deps: [{ token: i0.TemplateRef }, { token: i1.TeleportService }], target: i0.ɵɵFactoryTarget.Directive });
